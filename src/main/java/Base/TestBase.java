...
public class TestBase 
{
	...
	public TestBase() throws IOException
	{
		...
		OR=new Properties();
		f1=new File(System.getProperty("user.dir")+"/src/helper/hava/com/cicero/config/Config.Properties");
		file=new FileInputStream(f1);
		OR.load(file);
				
		f1=new File(System.getProperty("user.dir")+"/src/helper/hava/com/cicero/config/Or.Properties");
		file=new FileInputStream(f1);
		OR.load(file);
